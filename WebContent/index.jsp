...
<title>Hello</title>
<link rel="stylesheet" href="./css/blablacar.css">
...
<div class="MainWrapper">
	...
	<%@ include file="../jsp/header.jsp"%> 
		<!-- TheaterList -->
		<div class="TheaterList" id="Theaterlist"></div><!-- Theater List ends -->
		<div class="lastBlockDiv1">
			<div class="blockdivdriver"></div>
			<div class="blockdivdriver1"></div>
			<div class="clr"></div>
		</div>
				...
				<div id="hrishi1"  class="form">
					<div id="RegisterContainer1" class="container2">
						<form id="form" action="CommonController">
							...
							<input  type="hidden" name="actionLog" value="log">
