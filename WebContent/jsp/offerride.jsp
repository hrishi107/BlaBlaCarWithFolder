		...
		<div class="findRide">
			<div class="findRideDiv">
				...
				<div class="inputSearch">
					...
					<input name="from" id="Serching" onblur="demo.autocompleteFromLocation()" onkeyup="demo.autoCompleteFunction()" class="searchboxheader" type="text" placeholder="Leaving from" spellcheck="false" background-color: transparent;">
					<div id="autopopup"></div>
					<input type="hidden" name="fromLocation" id="fromLocation" value="">
					<input id="userId" name="userId" type="hidden" value="<%=userId%>">
					<span class="Span" id="ONNN"></span>
					<input name="to" id="Serching1" onblur="demo.autocompleteToLocation()" onkeyup="demo.autoCompleteFunctionTolocation()" class="searchboxheader" type="text" placeholder="Going to" spellcheck="false" background-color: transparent;">
				...
				<input onclick="return demo.validateRide()" id="submit" class="registerbtn" type="submit" value="Create Rides">
				<!-- <button onclick="return demo.resetRideForm()"  id="reset" type="reset" class="registerbtn1">Clear</button> -->
				<input type="hidden" name="action" value="createRide">
				</form>
			</div>
				...
				<div id="hrishi1"  class="form">
					<div id="RegisterContainer1" class="container2">
						<form id="form" action="<%=request.getContextPath()%>/CommonController">
							...
							<input id="actionType"  type="hidden" name="actionType" value="offerRide">
